...
import {hasCommonElement, isConnectedToAncestors} from "@/view/graph/nodes/node-utils.js";
import {ref} from "vue";
...
<template>
  <div v-tooltip.top="props.data.error" class="unionNode" :style="{ borderRadius: '5px',
