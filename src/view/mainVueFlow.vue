...
import {StandardNode, StartNode, EndNode, UnionNode, CustomEdge} from "@/view/graph/index.ts"
import Drawer from 'primevue/drawer';
import BlockOptions from "@/view/BlockOptions.vue";
import ActionPanel from "@/view/ActionPanel.vue";
import { MiniMap } from '@vue-flow/minimap'
import ErrorDetector from "@/controller/ErrorDetector.vue";
import { Controls } from '@vue-flow/controls'
import '@vue-flow/controls/dist/style.css'
import BlockMenu from "@/view/BlockMenu.vue";
...
const onNodeClick = (event: NodeMouseEvent) => {
  ...
  if (event.node.data.name.includes('custom')  || event.node.data.name === "lambda_operator") {
    modalRef.value = true;
  }
};
